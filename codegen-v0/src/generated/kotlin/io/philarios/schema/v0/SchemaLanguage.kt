...
class SchemaBuilder<out C>(
    ...
    fun <C, C2> SchemaBuilder<C>.context(context: C2, body: SchemaBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> SchemaBuilder<C>.forEachContext(context: List<C2>, body: SchemaBuilder<C2>.() -> Unit = {}) {
    ...
    operator fun SchemaSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class StructBuilder<out C>(
    ...
    fun <C, C2> StructBuilder<C>.context(context: C2, body: StructBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> StructBuilder<C>.forEachContext(context: List<C2>, body: StructBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun StructSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class UnionBuilder<out C>(
    ...
    fun <C, C2> UnionBuilder<C>.context(context: C2, body: UnionBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> UnionBuilder<C>.forEachContext(context: List<C2>, body: UnionBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun UnionSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class EnumTypeBuilder<out C>(
    ...
    fun <C, C2> EnumTypeBuilder<C>.context(context: C2, body: EnumTypeBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> EnumTypeBuilder<C>.forEachContext(context: List<C2>, body: EnumTypeBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun EnumTypeSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class OptionTypeBuilder<out C>(val context: C, private var type: Type? = null) : Builder<OptionType> {
    ...
    fun <C, C2> OptionTypeBuilder<C>.context(context: C2, body: OptionTypeBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> OptionTypeBuilder<C>.forEachContext(context: List<C2>, body: OptionTypeBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun OptionTypeSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class ListTypeBuilder<out C>(val context: C, private var type: Type? = null) : Builder<ListType> {
    ...
    fun <C, C2> ListTypeBuilder<C>.context(context: C2, body: ListTypeBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> ListTypeBuilder<C>.forEachContext(context: List<C2>, body: ListTypeBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun ListTypeSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class MapTypeBuilder<out C>(
    ...
    fun <C, C2> MapTypeBuilder<C>.context(context: C2, body: MapTypeBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> MapTypeBuilder<C>.forEachContext(context: List<C2>, body: MapTypeBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun MapTypeSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class RefTypeBuilder<out C>(val context: C, private var name: String? = null) : Builder<RefType> {
    ...
    fun <C, C2> RefTypeBuilder<C>.context(context: C2, body: RefTypeBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> RefTypeBuilder<C>.forEachContext(context: List<C2>, body: RefTypeBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun RefTypeSpec<C>.unaryPlus() {
        apply(body)
    }
}
...
class FieldBuilder<out C>(
    ...
    fun <C, C2> FieldBuilder<C>.context(context: C2, body: FieldBuilder<C2>.() -> Unit = {}) {
        val builder = split(context)
        body.invoke(builder)
        merge(builder)
    }

    fun <C, C2> FieldBuilder<C>.forEachContext(context: List<C2>, body: FieldBuilder<C2>.() -> Unit = {}) {
        context.forEach { context(it, body) }
    }
    ...
    operator fun FieldSpec<C>.unaryPlus() {
        apply(body)
    }
}
