...
class SchemaBuilder<out C>(
    ...
    fun <C> SchemaBuilder<C>.reference(reference: Schema) {
        this.references = this.references.orEmpty() + reference
    }

    fun <C> SchemaBuilder<C>.references(references: List<Schema>) {
        this.references = this.references.orEmpty() + references
    }
...
open class SchemaTranslator<in C>(private val spec: SchemaSpec<C>) : Translator<C, Schema> {
    constructor(body: SchemaBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.SchemaSpec<C>(body))
...
class StructBuilder<out C>(
    ...
    fun <C> StructBuilder<C>.field(field: Field) {
        this.fields = this.fields.orEmpty() + field
    }

    fun <C> StructBuilder<C>.fields(fields: List<Field>) {
        this.fields = this.fields.orEmpty() + fields
    }
...
class UnionBuilder<out C>(
    ...
    fun <C> UnionBuilder<C>.shape(shape: Struct) {
        this.shapes = this.shapes.orEmpty() + shape
    }

    fun <C> UnionBuilder<C>.shapes(shapes: List<Struct>) {
        this.shapes = this.shapes.orEmpty() + shapes
    }
...
open class StructTranslator<in C>(private val spec: StructSpec<C>) : Translator<C, Struct> {
    constructor(body: StructBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.StructSpec<C>(body))
...
open class UnionTranslator<in C>(private val spec: UnionSpec<C>) : Translator<C, Union> {
    constructor(body: UnionBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.UnionSpec<C>(body))
...
open class EnumTypeTranslator<in C>(private val spec: EnumTypeSpec<C>) : Translator<C, EnumType> {
    constructor(body: EnumTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.EnumTypeSpec<C>(body))
...
open class RefTypeTranslator<in C>(private val spec: RefTypeSpec<C>) : Translator<C, RefType> {
    constructor(body: RefTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.RefTypeSpec<C>(body))
...
open class OptionTypeTranslator<in C>(private val spec: OptionTypeSpec<C>) : Translator<C, OptionType> {
    constructor(body: OptionTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.OptionTypeSpec<C>(body))
...
open class ListTypeTranslator<in C>(private val spec: ListTypeSpec<C>) : Translator<C, ListType> {
    constructor(body: ListTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.ListTypeSpec<C>(body))
...
open class MapTypeTranslator<in C>(private val spec: MapTypeSpec<C>) : Translator<C, MapType> {
    constructor(body: MapTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.MapTypeSpec<C>(body))
...
open class BooleanTypeTranslator<in C>(private val spec: BooleanTypeSpec<C>) : Translator<C, BooleanType> {
    constructor(body: BooleanTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.BooleanTypeSpec<C>(body))
...
open class DoubleTypeTranslator<in C>(private val spec: DoubleTypeSpec<C>) : Translator<C, DoubleType> {
    constructor(body: DoubleTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.DoubleTypeSpec<C>(body))
...
open class FloatTypeTranslator<in C>(private val spec: FloatTypeSpec<C>) : Translator<C, FloatType> {
    constructor(body: FloatTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.FloatTypeSpec<C>(body))
...
open class LongTypeTranslator<in C>(private val spec: LongTypeSpec<C>) : Translator<C, LongType> {
    constructor(body: LongTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.LongTypeSpec<C>(body))
...
open class IntTypeTranslator<in C>(private val spec: IntTypeSpec<C>) : Translator<C, IntType> {
    constructor(body: IntTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.IntTypeSpec<C>(body))
...
open class ShortTypeTranslator<in C>(private val spec: ShortTypeSpec<C>) : Translator<C, ShortType> {
    constructor(body: ShortTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.ShortTypeSpec<C>(body))
...
open class ByteTypeTranslator<in C>(private val spec: ByteTypeSpec<C>) : Translator<C, ByteType> {
    constructor(body: ByteTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.ByteTypeSpec<C>(body))
...
open class CharacterTypeTranslator<in C>(private val spec: CharacterTypeSpec<C>) : Translator<C, CharacterType> {
    constructor(body: CharacterTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.CharacterTypeSpec<C>(body))
...
open class StringTypeTranslator<in C>(private val spec: StringTypeSpec<C>) : Translator<C, StringType> {
    constructor(body: StringTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.StringTypeSpec<C>(body))
...
open class AnyTypeTranslator<in C>(private val spec: AnyTypeSpec<C>) : Translator<C, AnyType> {
    constructor(body: AnyTypeBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.AnyTypeSpec<C>(body))
...
open class FieldTranslator<in C>(private val spec: FieldSpec<C>) : Translator<C, Field> {
    constructor(body: FieldBuilder<C>.() -> Unit) : this(io.philarios.schema.v0.FieldSpec<C>(body))
